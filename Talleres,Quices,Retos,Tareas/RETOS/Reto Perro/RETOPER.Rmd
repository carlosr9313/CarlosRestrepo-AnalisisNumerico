...
Si tenemos nueva información osea nodos como podemos implementar esa información en el algoritmo de interpolación?
...
xd = c(1,2,5,6,7,8.1,10,13,17.6,20,23,24,25,27,27.7,28,29,30)
yd = c(3.0,3.7,3.9,4.2,5.7,6.6,7.1,6.7,4.5,7.0,6.1,5.6,5.8,5.2,4.1,4.3,4.1,3.0)
...
DibujarLinea2<-function(inicio, final){
  xi0 = xd[inicio:final]
  yi0 = yd[inicio:final]
